...
Prefix enforcement in env validation reduces operational overhead for a solo/small team while prod data still lives under a distinct prefix. Migration to 2- or 3-bucket layout will require a dedicated ADR before cutover.
